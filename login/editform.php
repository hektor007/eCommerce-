<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT userName,Phoneno,Address, userProfession, userPic FROM tbl_users WHERE userID =:uid');
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">update profile. <a class="btn btn-default" href="home.php"> ACCOUNT </a></h1>
    </div>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="Phoneno" value="<?php echo $Phoneno; ?>" required /></td>
    </tr>
